...
public class ShWebpageContent {
    ...
    private void createWebView(String url, Context context, ShWebpageInterface shWebpageInterface, SSLContext sslContext)  {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
                ...
                String errorMessage = "Status code: " + statusCode + "\n\nHeaders: " + errorResponse.getResponseHeaders().toString() + "\n\nURL: " + request.getUrl().toString();
                loadingInformation.add(new UserInformation(InformationType.WARNING, InformationTitle.HttpError, errorMessage));
            }
     ...
     */
    @Nullable
    public ArrayList<ShRoom> getSmartHomeData() throws JSONException {
        if (document != null) {
